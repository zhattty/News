                 ...
                 <div class="post">
                    ...
                    <div class="user-info">
                        <div class="user-avatar">
                            <a href="${contextPath!}/user/${vo.news.user.id!}/"><img width="32" class="img-circle" src="${vo.news.user.headUrl!}"></a>
                        </div>


                    </div>

                    <div class="subject-name">来自 <a href="${contextPath!}/user/${vo.news.user.id!}/">${vo.news.user.name!}</a></div>
                </div>
